...
def custom_quill_validation_using_inputbox(request):
    ...
    if request.method == 'POST':
        ...
        quill_data.objects.create(description=data)
        print('custom_quill_validation_using_inputbox data saved successfully')


    return render(request, 'quill/1.2_custom_quill_validation_using_inputbox.html')