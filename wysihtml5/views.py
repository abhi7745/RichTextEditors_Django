...
def wysihtml5_validation_using_inputbox(request):
    ...
    if request.method == 'POST':
        ...
        wysihtml5_data.objects.create(description=data)
        print('wysihtml5_validation_using_inputbox data saved successfully')

    return render(request, 'wysihtml5/1.1_wysihtml5_validation_using_inputbox.html')